...
- [public/index.html](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/public/index.html): Main HTML structure with localization data attributes.
- [public/style.css](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/public/style.css): Custom CSS with glassmorphism and Proton-inspired styling.
- [public/translations.js](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/public/translations.js): Dictionary containing all localized strings.
- [wrangler.toml](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/wrangler.toml): Cloudflare Pages configuration.
- [public/assets/logo.png](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/public/assets/logo.png): Project logo.
- [public/assets/hero.webp](file:///home/smh01/Studio%20canaryProjects/ProtonVPN-Next/public/assets/hero.webp): Hero section illustration.
...
3. Drag and drop the contents of the **`public/`** folder.

### Option 2: Wrangler CLI (Recommended for speed)
Run the following command in your terminal:
```bash
npx wrangler pages deploy public --project-name=protonvpn-next
```
