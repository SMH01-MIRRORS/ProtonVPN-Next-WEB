...
class SettingsManager @Inject constructor(
    ...
    companion object {
        ...
        private val AWG_ID = stringPreferencesKey("awg_id")
        private val AWG_IP = stringPreferencesKey("awg_ip")
        private val AWG_IB = stringPreferencesKey("awg_ib")
            ...
            for (i in 0 until array.length()) {
                ...
                list.add(
                    ObfuscationProfile(
                        ...
                        i4 = obj.optString("i4", ""),
                        i5 = obj.optString("i5", ""),
                        customId = obj.optString("customId", ""),
                        ip = obj.optString("ip", ""),
                        ib = obj.optString("ib", ""),
    ...
    val awgId: Flow<String> = context.dataStore.data.map { it[AWG_ID] ?: "" }
    val awgIp: Flow<String> = context.dataStore.data.map { it[AWG_IP] ?: "" }
    val awgIb: Flow<String> = context.dataStore.data.map { it[AWG_IB] ?: "" }
